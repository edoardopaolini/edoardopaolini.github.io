...
You are invited to explore my <a href="{{ '/bio/' | relative_url }}" class="text-link">Biography</a> for more details on my academic path, or visit the <a href="{{ '/publications/' | relative_url }}" class="text-link">Publications</a> section to review my research.
